...
package cc.wan7.bear.auth.endpoint;
...
import cc.wan7.bear.admin.api.entity.SysOauthClientDetails;
import cc.wan7.bear.admin.api.feign.RemoteClientDetailsService;
import cc.wan7.bear.admin.api.vo.TokenVo;
import cc.wan7.bear.auth.support.handler.BearAuthenticationFailureEventHandler;
import cc.wan7.bear.common.core.constant.CacheConstants;
...
import cc.wan7.bear.common.core.util.SpringContextHolder;
import cc.wan7.bear.common.security.annotation.Inner;
import cc.wan7.bear.common.security.util.OAuth2EndpointUtils;
import cc.wan7.bear.common.security.util.OAuth2ErrorCodesExpand;
import cc.wan7.bear.common.security.util.OAuthClientException;
...
public class BearTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new BearAuthenticationFailureEventHandler();
