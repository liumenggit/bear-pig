package cc.wan7.bear.common.job;

import cc.wan7.bear.common.job.properties.XxlExecutorProperties;
import cc.wan7.bear.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://bear-xxl:9080/xxl-job-admin"
