...
import cc.wan7.bear.admin.api.feign.RemoteUserService;
...
public class BearAppUserDetailsServiceImpl implements BearUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (BearUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(BearUser bearUser) {
		return this.loadUserByUsername(bearUser.getPhone());
	}
