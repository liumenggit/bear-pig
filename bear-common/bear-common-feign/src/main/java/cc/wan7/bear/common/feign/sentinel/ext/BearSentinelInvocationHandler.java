...
import cc.wan7.bear.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class BearSentinelInvocationHandler implements InvocationHandler {
	...
	BearSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			BearSentinelInvocationHandler other = (BearSentinelInvocationHandler) obj;
