...
package cc.wan7.bear.codegen;

import cc.wan7.bear.common.datasource.annotation.EnableDynamicDataSource;
...
public class BearCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(BearCodeGenApplication.class, args);
	}
